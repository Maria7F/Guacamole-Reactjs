...
export default class KitchenIndex extends Component {
    ...
    deleteKitchen = (id) => {
        axios.delete(`https://cors-anywhere.herokuapp.com/http://guacamole-env.eba-mumrxm3n.us-east-2.elasticbeanstalk.com/kitchen/delete?id=${id}`,
        {
            headers: {
    ...
    editKitchen = (kitchen) =>{
        axios.put("https://cors-anywhere.herokuapp.com/http://guacamole-env.eba-mumrxm3n.us-east-2.elasticbeanstalk.com/kitchen/edit", kitchen, {
            headers: {
                "Authorization": "Bearer " + localStorage.getItem("token")
            }
        })
